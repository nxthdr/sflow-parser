...
The project includes comprehensive [validation](tests/specs/README.md) against official sFlow specification documents using `syn` crate to parse Rust source files and extract sFlow struct metadata:
